...
const SearchBar = ({ onOpenImageModal }) => {
  ...
  }, [location.search, clearSearchResults]);
    ...
    <div className="flex-1 mx-2 max-w-xl lg:flex relative" ref={searchRef}>
      <form onSubmit={handleSearchSubmit} className="w-full">
        <div className="flex items-center bg-gray-100 rounded-full px-4 py-2 w-full">
          ...
          />
          <button onClick={onOpenImageModal} className="cursor-pointer hover:opacity-75 transition">
